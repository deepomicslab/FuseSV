package FuseSV::Virus_Integ::ReadsGroup_OB;
...
use FuseSV::Distribution::DistStat;
require Exporter;
...
sub evalue_ins{
	...
	my $Dist_Href = FuseSV::Distribution::DistStat->engineer_Ntimes_SD_evaluation( Value2Count_Href => $rg_OB->{Ins_Stat}, ratio_digit => 0 );
