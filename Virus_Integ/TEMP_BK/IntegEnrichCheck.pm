package FuseSV::Virus_Integ::IntegEnrichCheck;
...
@ISA = qw(Exporter);
@EXPORT = qw/
			  real_check_vinteg_enrichment
			/;
@EXPORT_OK = qw();
%EXPORT_TAGS = ( DEFAULT => [qw()],
                 OTHER   => [qw()]);

$MODULE_NAME = 'IntegEnrichCheck';
#----- version --------
$VERSION = "0.01";
$DATE = '2018-02-19';
...
sub real_check_vinteg_enrichment{
	...
	#--------------#
	# &prepare;
	warn_and_exit "real_check_vinteg_enrichment is in development\n";
}
