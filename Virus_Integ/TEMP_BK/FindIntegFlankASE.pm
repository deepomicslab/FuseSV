package FuseSV::Virus_Integ::FindIntegFlankASE;
...
@ISA = qw(Exporter);
@EXPORT = qw/
			  real_find_ASE_flank_virus_integration
			/;
@EXPORT_OK = qw();
%EXPORT_TAGS = ( DEFAULT => [qw()],
                 OTHER   => [qw()]);

$MODULE_NAME = 'FindIntegFlankASE';
#----- version --------
$VERSION = "0.01";
$DATE = '2018-02-19';
...
sub return_HELP_INFO{
 ...
 return "
	 Usage:   perl $V_Href->{MainName} vitg_ASE <[Options]>
...
sub real_find_ASE_flank_virus_integration{
	...
	#--------------#
	# &prepare;
	warn_and_exit "real_find_ASE_flank_virus_integration is in development\n";
}
