...
use BioFuse::Visual::SVG_Util::RectSysEle qw/draw_a_parallelogram draw_a_triangle/;
use BioFuse::Visual::SVG_Util::Font qw /show_text_in_line get_size_of_text_to_show/;
use BioFuse::Visual::ArrangeObj qw/ allocate_object_bilater /;
...
use SVG;
use BioFuse::BioInfo::Depth qw/ get_windowSmoDepth deal_window_depth_info /;
use FuseSV::LoadOn;
use FuseSV::GetPath;
